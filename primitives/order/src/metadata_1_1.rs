...
pub mod api {
	...
	pub mod runtime_types {
        ...
        pub mod bounded_collections {
			...
			pub mod bounded_vec {
				use super::runtime_types;
				#[derive(:: codec :: Decode, :: codec :: Encode, Clone, Debug, PartialEq, Eq, scale_info::TypeInfo)]
        ...
        pub mod sp_runtime {
            ...
            #[derive(:: codec :: Decode, :: codec :: Encode, Clone, Debug, PartialEq, Eq, TypeInfo)]
        ...
        pub mod pallet_balances {
			...
			pub mod pallet {
				...
				pub enum Event {
					...
					#[codec(index = 14)]
					Upgraded { who: runtime_types::sp_core::crypto::AccountId32 },
					#[codec(index = 15)]
        ...
        pub mod polkadot_primitives {
			...
			pub mod v5 {
				...
				// 	Explicit,
				// 	#[codec(index = 1)]
				// 	BackingSeconded(runtime_types::primitive_types::H256),
				// 	#[codec(index = 2)]
				// 	BackingValid(runtime_types::primitive_types::H256),
				// 	#[codec(index = 3)]
				// 	ApprovalChecking,
				// }
				// #[derive(
        ...
        pub mod pallet_im_online {
			...
			pub mod pallet {
				...
				pub enum Event {
					...
					#[codec(index = 2)]
					SomeOffline {
						offline: ::sp_std::vec::Vec<(runtime_types::sp_core::crypto::AccountId32, ())>,
					},
				}
            }
            pub mod sr25519 {
        ...
        pub mod pallet_elections_phragmen {
			...
			pub mod pallet {
				...
				pub enum Event {
					...
					ElectionError,
					#[codec(index = 3)]
					MemberKicked { member: runtime_types::sp_core::crypto::AccountId32 },
					#[codec(index = 4)]
					Renounced { candidate: runtime_types::sp_core::crypto::AccountId32 },
					#[codec(index = 5)]
					CandidateSlashed {
						candidate: runtime_types::sp_core::crypto::AccountId32,
						amount: ::core::primitive::u128,
					},
					#[codec(index = 6)]
					SeatHolderSlashed {
						seat_holder: runtime_types::sp_core::crypto::AccountId32,
						amount: ::core::primitive::u128,
					},
				}
            }
            ...
            pub mod paras_registrar {
				...
				pub mod pallet {
					...
					pub enum Event {
						...
						Registered {
							para_id: runtime_types::polkadot_parachain_primitives::primitives::Id,
							manager: runtime_types::sp_core::crypto::AccountId32,
						},
						#[codec(index = 1)]
						Deregistered {
							para_id: runtime_types::polkadot_parachain_primitives::primitives::Id,
            ...
            pub mod slots {
				...
				pub mod pallet {
					...
					pub enum Event {
						...
						Leased {
							para_id: runtime_types::polkadot_parachain_primitives::primitives::Id,
							leaser: runtime_types::sp_core::crypto::AccountId32,
            ...
            pub mod auctions {
				...
				pub mod pallet {
					...
					pub enum Event {
						...
						#[codec(index = 2)]
						Reserved {
							bidder: runtime_types::sp_core::crypto::AccountId32,
							extra_reserved: ::core::primitive::u128,
							total_amount: ::core::primitive::u128,
						},
						#[codec(index = 3)]
		...
		pub mod pallet_society {
			...
			pub mod pallet {
				...
				pub enum Event {
					#[codec(index = 0)]
					Founded { founder: runtime_types::sp_core::crypto::AccountId32 },
					#[codec(index = 1)]
					Bid {
						candidate_id: runtime_types::sp_core::crypto::AccountId32,
					...
					Vouch {
						candidate_id: runtime_types::sp_core::crypto::AccountId32,
						offer: ::core::primitive::u128,
						vouching: runtime_types::sp_core::crypto::AccountId32,
					},
					#[codec(index = 3)]
					AutoUnbid { candidate: runtime_types::sp_core::crypto::AccountId32 },
					#[codec(index = 4)]
					Unbid { candidate: runtime_types::sp_core::crypto::AccountId32 },
					#[codec(index = 5)]
					Unvouch { candidate: runtime_types::sp_core::crypto::AccountId32 },
					#[codec(index = 6)]
					Inducted {
						primary: runtime_types::sp_core::crypto::AccountId32,
						candidates: ::sp_std::vec::Vec<runtime_types::sp_core::crypto::AccountId32>,
					},
					#[codec(index = 7)]
					...
					#[codec(index = 8)]
					CandidateSuspended { candidate: runtime_types::sp_core::crypto::AccountId32 },
					#[codec(index = 9)]
					MemberSuspended { member: runtime_types::sp_core::crypto::AccountId32 },
					#[codec(index = 10)]
					Challenged { member: runtime_types::sp_core::crypto::AccountId32 },
					#[codec(index = 11)]
					Vote {
						candidate: runtime_types::sp_core::crypto::AccountId32,
						voter: runtime_types::sp_core::crypto::AccountId32,
					...
					#[codec(index = 14)]
					Unfounded { founder: runtime_types::sp_core::crypto::AccountId32 },
					#[codec(index = 15)]
					Deposit { value: ::core::primitive::u128 },
					#[codec(index = 16)]
					Elevated {
						member: runtime_types::sp_core::crypto::AccountId32,
		...
		pub mod pallet_recovery {
			...
			pub mod pallet {
				...
				pub enum Event {
					#[codec(index = 0)]
					RecoveryCreated { account: runtime_types::sp_core::crypto::AccountId32 },
					#[codec(index = 1)]
					RecoveryInitiated {
						lost_account: runtime_types::sp_core::crypto::AccountId32,
						rescuer_account: runtime_types::sp_core::crypto::AccountId32,
					},
					#[codec(index = 2)]
					RecoveryVouched {
						lost_account: runtime_types::sp_core::crypto::AccountId32,
					...
					#[codec(index = 5)]
					RecoveryRemoved { lost_account: runtime_types::sp_core::crypto::AccountId32 },
				}
            }
        }
		pub mod pallet_vesting {
			...
			pub mod pallet {
				...
				pub enum Event {
					...
					#[codec(index = 1)]
					VestingCompleted { account: runtime_types::sp_core::crypto::AccountId32 },
				}
            }
        }
		...
		pub mod pallet_tips {
			...
			pub mod pallet {
				...
				pub enum Event {
					...
					TipSlashed {
						tip_hash: runtime_types::primitive_types::H256,
						finder: runtime_types::sp_core::crypto::AccountId32,
						deposit: ::core::primitive::u128,
					},
				}
            }
			...
			pub mod v2 {
				...
				pub mod multiasset {
					...
					pub struct MultiAssets(
						pub ::sp_std::vec::Vec<runtime_types::staging_xcm::v2::multiasset::MultiAsset>,
					);
					#[derive(:: codec :: Decode, :: codec :: Encode, Clone, Debug, PartialEq, Eq, scale_info::TypeInfo)]
				...
				#[derive(:: codec :: Decode, :: codec :: Encode, Clone, Debug, PartialEq, Eq, scale_info::TypeInfo)]
				pub struct Xcm2(pub ::sp_std::vec::Vec<runtime_types::staging_xcm::v2::Instruction2>);
			}
			pub mod v3 {
				use super::runtime_types;
				pub mod junction {
				...
				pub mod multiasset {
					...
					#[derive(:: codec :: Decode, :: codec :: Encode, Clone, Debug, PartialEq, Eq, scale_info::TypeInfo)]
					pub struct MultiAssets(
						pub ::sp_std::vec::Vec<runtime_types::staging_xcm::v3::multiasset::MultiAsset>,
					);
					#[derive(:: codec :: Decode, :: codec :: Encode, Clone, Debug, PartialEq, Eq, scale_info::TypeInfo)]
					pub enum WildFungibility {
						#[codec(index = 0)]
				...
				pub mod pallet {
					...
					pub enum Event {
						...
						ValidatorsRegistered(
							::sp_std::vec::Vec<runtime_types::sp_core::crypto::AccountId32>,
						),
						#[codec(index = 1)]
