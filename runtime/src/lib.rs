...
construct_runtime!(
	pub enum Runtime
	{
		...
		Origins: pallet_custom_origins::{Origin} = 51,
		Whitelist: pallet_whitelist = 52,

		// System scheduler.
		Scheduler: pallet_scheduler = 53,

		// Preimage registrar.
		Preimage: pallet_preimage::{Pallet, Call, Storage, Event<T>, HoldReason} = 54,
