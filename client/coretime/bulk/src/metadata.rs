	...
	pub mod utility {
		...
		pub mod calls {
			...
			pub mod types {
				...
				#[encode_as_type(crate_path = ":: subxt :: ext :: scale_encode")]
				pub struct Batch {
					pub calls: ::std::vec::Vec<runtime_types::coretime_rococo_runtime::RuntimeCall>,
				}
				...
				pub struct AsDerivative {
					...
					pub call:
						::std::boxed::Box<runtime_types::coretime_rococo_runtime::RuntimeCall>,
				}
				...
				pub struct DispatchAs {
					pub as_origin:
						::std::boxed::Box<runtime_types::coretime_rococo_runtime::OriginCaller>,
					pub call:
						::std::boxed::Box<runtime_types::coretime_rococo_runtime::RuntimeCall>,
				}
			...
			impl TransactionApi {
				...
				pub fn batch(
					&self,
					calls: ::std::vec::Vec<runtime_types::coretime_rococo_runtime::RuntimeCall>,
	...
	pub mod broker {
			...
			impl TransactionApi {
				...
				pub fn reserve(
					...
					workload: runtime_types::bounded_collections::bounded_vec::BoundedVec<
						runtime_types::pallet_broker::types::ScheduleItem,
					>,
				) -> ::subxt::tx::Payload<types::Reserve> {
					::subxt::tx::Payload::new_static(
						"Broker",
						"reserve",
				...
				) -> ::subxt::tx::Payload<types::Unreserve> {
					::subxt::tx::Payload::new_static(
						"Broker",
						"unreserve",
				...
				) -> ::subxt::tx::Payload<types::SetLease> {
					::subxt::tx::Payload::new_static(
						"Broker",
						"set_lease",
				...
				) -> ::subxt::tx::Payload<types::StartSales> {
					::subxt::tx::Payload::new_static(
						"Broker",
						"start_sales",
				...
				) -> ::subxt::tx::Payload<types::Purchase> {
					::subxt::tx::Payload::new_static(
						"Broker",
						"purchase",
				...
				) -> ::subxt::tx::Payload<types::Partition> {
					::subxt::tx::Payload::new_static(
						"Broker",
						"partition",
				...
				) -> ::subxt::tx::Payload<types::Interlace> {
					::subxt::tx::Payload::new_static(
						"Broker",
						"interlace",
				...
				) -> ::subxt::tx::Payload<types::ClaimRevenue> {
					::subxt::tx::Payload::new_static(
						"Broker",
						"claim_revenue",
				...
				) -> ::subxt::tx::Payload<types::PurchaseCredit> {
					::subxt::tx::Payload::new_static(
						"Broker",
						"purchase_credit",
				...
				pub fn drop_region(
					&self,
					region_id: runtime_types::pallet_broker::types::RegionId,
				) -> ::subxt::tx::Payload<types::DropRegion> {
					::subxt::tx::Payload::new_static(
						"Broker",
						"drop_region",
				...
				pub fn drop_contribution(
					&self,
					region_id: runtime_types::pallet_broker::types::RegionId,
				) -> ::subxt::tx::Payload<types::DropContribution> {
					::subxt::tx::Payload::new_static(
						"Broker",
						"drop_contribution",
				...
				) -> ::subxt::tx::Payload<types::DropHistory> {
					::subxt::tx::Payload::new_static(
						"Broker",
						"drop_history",
				...
				pub fn drop_renewal(
					...
					core: ::core::primitive::u16,
					when: ::core::primitive::u32,
				) -> ::subxt::tx::Payload<types::DropRenewal> {
					::subxt::tx::Payload::new_static(
						"Broker",
						"drop_renewal",
				...
				pub fn request_core_count(
					&self,
					core_count: ::core::primitive::u16,
				) -> ::subxt::tx::Payload<types::RequestCoreCount> {
					::subxt::tx::Payload::new_static(
						"Broker",
						"request_core_count",
				...
				pub fn notify_core_count(
					&self,
					core_count: ::core::primitive::u16,
				) -> ::subxt::tx::Payload<types::NotifyCoreCount> {
					::subxt::tx::Payload::new_static(
						"Broker",
						"notify_core_count",
		...
		pub mod events {
			...
			pub struct RevenueClaimPaid {
				pub who: ::subxt::utils::AccountId32,
				pub amount: ::core::primitive::u128,
				pub next: ::core::option::Option<runtime_types::pallet_broker::types::RegionId>,
			}
		...
		pub mod storage {
			...
			impl StorageApi {
				...
				pub fn regions(
					&self,
					_0: impl ::std::borrow::Borrow<runtime_types::pallet_broker::types::RegionId>,
				) -> ::subxt::storage::address::Address<
					::subxt::storage::address::StaticStorageMapKey,
					runtime_types::pallet_broker::types::RegionRecord<
						::subxt::utils::AccountId32,
			...
			pub mod pallet {
				...
				pub enum Event {
					...
					RevenueClaimPaid {
						who: ::subxt::utils::AccountId32,
						amount: ::core::primitive::u128,
						next: ::core::option::Option<runtime_types::pallet_broker::types::RegionId>,
					},
					#[codec(index = 19)]
					#[doc = "Some Instantaneous Coretime Pool credit has been purchased."]
					CreditPurchased {
